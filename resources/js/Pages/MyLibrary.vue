<template>
    ...
    <div class="bg-gray-100">
        <div class="mx-48">
            ...
            <div class="flex flex-row justify-between px-6 py-3 bg-white rounded-lg">
                <div class="flex flex-row">
                    ...
                    <div class="flex flex-col">
                        <div class="font-bold text-black text-md">Lesson 1</div>
                        <div
                            class="font-semibold text-gray-500 capitalize text-2xs"
                        >course: laravel-9 | published jan 12th, 2022</div>
                    </div>
                </div>
                <div class="flex flex-row items-center space-x-5">
                    ...
                    <div class="flex flex-row text-gray-500">
                        <div class="flex flex-row items-center text-xs">
                            ...
                            <div class="text-2xs">12 minutes</div>
                        </div>
                    </div>
                    <!-- watch button -->
                    <div>
            ...
            <div v-for="lesson in watchlistedLessons" :key="lesson.id">
                <div
                    class="grid justify-between grid-cols-8 col-span-5 p-6 shadow-xl bg-gradient-to-r from-gray-700 to-black mt-7 rounded-xl"
                >
                    <div class="flex flex-col justify-between w-full col-span-5">
                        <div class="mt-2 ml-5 mr-10">
                            <h2
                                class="mb-2 text-4xl font-semibold text-white"
                            >{{lesson.course.name}}</h2>
                        ...
                        <div class="flex flex-col justify-between mt-2 ml-5 mr-10">
                            ...
                            <div class="flex flex-row">
                                ...
                                >
                                    <Link class="flex flex-row items-center justify-center">
                                        <div>
                                            <svg
                                                width="15"
                                                height="15"
